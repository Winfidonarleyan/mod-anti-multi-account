...
-- Announce GM
(@FirstID + 1, CONCAT(@sytemlogo, @green, "Character", @r, " %s ", @green, "just logged in and has", @r, " %.1f ", @green, "AMAS points.", @r), CONCAT(@sytemlogo, @green, "Игрок", @r, " %s ", @green , "имеет", @r, " %.1f ", @green, "очков подозрительности", @r)),

-- AMAS info
(@FirstID + 2, CONCAT(
"Character %s", @n, "-------", @n, "Total points: ", @red, "%.1f", @r, @n,
@red, "%.1f", @r, " - Time played on account: %s", @n,
@red, "%.1f", @r, " - Average item level: %u", @n,
@red, "%.1f", @r, " - Unused talent points: %u", @n,
@red, "%.1f", @r, " - Completed quests count: %u", @n,
@red, "%.1f", @r, " - Friend count: %u", @n,
@red, "%.1f", @r, " - Money: %s", @n,
@red, "%.1f", @r, " - Honor: %u. Kills: %u", @n,
@red, "%.1f", @r, " - IP: %s --> %s", @n,
@red, "%.1f", @r, " - Missing trainer spells: %u", @n,
@red, "%.1f", @r, " - Current zone: %u - %s%s", @n,
@red, "%.1f", @r, " - Profession count: %u", @n,
@red, "%.1f", @r, " - Session count: %u. Avg session duration: %s", @n,
"Time played on character: %s", @n,
"Comment count: %i"), CONCAT("Игрок %s. |cffff0000%.1f|r", @n,
"-------", @n,
@red, "%.1f", @r, " - Игровое время на аккаунте: %s", @n,
@red, "%.1f", @r, " - Средний уровень предметов: %u", @n,
@red, "%.1f", @r, " - Свободных талантов: %u", @n,
@red, "%.1f", @r, " - Пройденных заданий: %u", @n,
@red, "%.1f", @r, " - Количество друзей: %u", @n,
@red, "%.1f", @r, " - Деньги: %s", @n,
@red, "%.1f", @r, " - Очки чести: %u. Убийства: %u", @n,
@red, "%.1f", @r, " - Айпи: %s --> %s", @n,
@red, "%.1f", @r, " - Не изученных заклинаний: %u", @n,
@red, "%.1f", @r, " - Находится в зоне: %u - %s%s", @n,
@red, "%.1f", @r, " - Количество профессий: %u", @n,
@red, "%.1f", @r, " - Сессия. Номер: %u. В среднем: %s", @n,
...
@sytemlogo, @green, "Character Points: ", @r, "%.1f \n",
@sytemlogo, @green, "AMAS maximum points before confirmation: ", @r, " %u \n"),
CONCAT(@sytemlogo, @green, "Подтверждённый игрок", @r, " %s ", @green, "имеет", @r, " %.1f ", @green, "очков подозрительности. Это больше минимума", @r, " %u")),
