...
-- AMAS info
(@FirstID + 2, CONCAT('Character %s', @n, '-------', @n, 'Total points: ', @red, '%.2f', @r, @n, @red, '%.2f', @r, ' - Time played on account: %s', @n, @red, '%.2f', @r, ' - Average item level: %u', @n, @red, '%.2f', @r, ' - Unused talent points: %u', @n, @red, '%.2f', @r, ' - Completed quests count: %u', @n, @red, '%.2f', @r, ' - Friend count: %u', @n, @red, '%.2f', @r, ' - Money: %s', @n, @red, '%.2f', @r, ' - Honor: %u. Kills: %u', @n, @red, '%.2f', @r, ' - IP: %s. Unique? (%s).%s%s', @n, @red, '%.2f', @r, ' - Missing trainer spells: %u', @n, @red, '%.2f', @r, ' - Current zone: %u - %s%s', @n, @red, '%.2f', @r, ' - Profession count: %u', @n, @red, '%.2f', @r, ' - Average session time: %s.', @n, 'Time played on character: %s', @n, 'Comment count: %i'), CONCAT('Игрок %s. |cffff0000%.2f|r', @n, '-------', @n, @red, '%.2f', @r, ' - Игровое время на аккаунте: %s', @n, @red, '%.2f', @r, ' - Средний уровень предметов: %u', @n, @red, '%.2f', @r, ' - Свободных талантов: %u', @n, @red, '%.2f', @r, ' - Пройденных заданий: %u', @n, @red, '%.2f', @r, ' - Количество друзей: %u', @n, @red, '%.2f', @r, ' - Деньги: %s', @n, @red, '%.2f', @r, ' - Очки чести: %u. Убийства: %u', @n, @red, '%.2f', @r, ' - Айпи: %s. Унивальное? (%s).%s%s', @n, @red, '%.2f', @r, ' - Не изученных заклинаний: %u', @n, @red, '%.2f', @r, ' - Находится в зоне: %u - %s%s', @n, @red, '%.2f', @r, ' - Количество профессий: %u', @n, @red, '%.2f', @r, ' - Среднее время сессии: %s', @n, 'Игровое время на персонаже: %s', @n, 'Количество комментариев: %i')),
