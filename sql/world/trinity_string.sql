...
(@FirstID, 'Character %s just logged in and has %.2f AMAS points.', 'Игрок %s имеет %.2f очков подозрительности'),
(@FirstID + 1, 'Character %s is offline and has no entry in the Database.', 'Игрок %s не в сети и ещё не сохранён в БД'),
...
(@FirstID + 16, 'There is no suspicious online character.', 'Такие онлайн игроки не найдены'),
(@FirstID + 17, 'Suspicious offline players:', 'Список топа оффлайн игроков по очкам подозреваемости:'),
(@FirstID + 18, 'There is no suspicious offline character.', 'Такие оффлайн игроки не найдены'),
...
(@FirstID + 25, '|cFFFF0000#|r |cff00ff00No comment found for character:|r %s.', '|cFFFF0000#|r |cff00ff00Не найдены комментарии для игрока:|r %s'),
...
(@FirstID + 30, '|cFFFF0000#|r |cff00ff00List comments for character|r %s.', '|cFFFF0000#|r |cff00ff00Список комментариев для игрока|r %s'),
